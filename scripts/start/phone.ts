import { filledName } from '../start/start.js'
import { keys } from '../start/start.js'
...
function selectCountry <T extends { code: string, flag: string, name: string }> (country: T) {
...
function updateDigitCounter(value: string) {
